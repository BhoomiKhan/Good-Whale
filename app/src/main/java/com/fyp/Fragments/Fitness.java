...
public class Fitness extends Fragment implements View.OnClickListener {
    ...
    //it will show the view/layout inside the fitness tab
    @Nullable
    @Override
    ...
    private void initilizer() {
        ...
        if (Utilities.checkStatus(getActivity(), "fitness_active_button") == true) {
    ...
    public void onClick(View view) {
        if (view.getId() == btnsumbit.getId()) {
            ...
            loadImageAndDescription();
            Utilities.saveStatus(getActivity(), "fitness_active_button");
            Utilities.setAlarm(getActivity(), "Fitness", "fitness_task_counter");
            activelayout.setVisibility(View.VISIBLE);
            unactivelayout.setVisibility(View.GONE);
    ...
    private void loadImageAndDescription() {
        ...
        int taskNumber = Utilities.getLastTaskNumber(getActivity(), "fitness_task_counter");
        ...
        String url = Constants.fitnessImageUrl + Integer.toString(taskNumber) + ".jpg";
        Log.d("urls",url);
