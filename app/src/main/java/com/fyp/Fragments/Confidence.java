...
public class Confidence extends Fragment implements View.OnClickListener {
    ...
    private void initilizer() {
        ...
        if (Utilities.checkStatus(getActivity(), "confidence_active_button") == true) {
    ...
    public void onClick(View view) {
        if (view.getId() == btnsumbit.getId()) {
            ...
            } else if (btnsumbit.getText().toString().equalsIgnoreCase("Submitted")) {
            ...
            loadImageAndDescription();
            Utilities.saveStatus(getActivity(), "confidence_active_button");
            Utilities.setAlarm(getActivity(), "Confidence", "confidence_task_counter");
            activelayout.setVisibility(View.VISIBLE);
            unactivelayout.setVisibility(View.GONE);
    ...
    private void loadImageAndDescription() {
        ...
        int taskNumber = Utilities.getLastTaskNumber(getActivity(), "confidence_task_counter");
        ...
        String url = Constants.selfImageUrl + Integer.toString(taskNumber) + ".jpg";
        Log.d("urls",url);
